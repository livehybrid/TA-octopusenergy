"""
Shared fixtures for the TA-octopusenergy integration suite.
...
Environment (defaults suit the docker harness):
  ...
  SPLUNK_CONTAINER  container name for     (default ta_octopusenergy_splunk)
...
CONTAINER = os.environ.get("SPLUNK_CONTAINER", "ta_octopusenergy_splunk")
